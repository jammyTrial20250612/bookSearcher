      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden mb-8">
          <div className="flex justify-end h-32 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 ">
            <button className="w-24 h-16 bg-green-400 hover:bg-green-200 px-8 py-4 m-12">更新</button>
            </div>
          <div className="px-8 pb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-end -mt-16 mb-6">
              ...
              <div className="sm:ml-6 flex-1">
                ...
                <p className="text-xl text-purple-600 font-semibold mb-2">{currentUser?.role}</p>
