          ...
          <div className="px-8 pb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-end -mt-16 mb-6">
              ...
              <div className="sm:ml-6 flex-1">
                ...
                <p className="text-xl text-purple-600 font-semibold mb-2">{user.role}</p>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              ...
              {user.skills.length > 0 ? (
                ...
                <p className="text-gray-500 italic">スキル情報が登録されていません</p>
              )}
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 pb-4 border-b border-gray-100">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">プロジェクトを完了しました</p>
                ...
                <div className="flex items-start space-x-3 pb-4 border-b border-gray-100">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">5件のコメントを追加</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">チームに参加しました</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium text-gray-700">貢献度</span>
                  </div>
